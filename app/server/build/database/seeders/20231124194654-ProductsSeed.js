    ...
    up: async (queryInterface) => {
        await queryInterface.bulkInsert('products', [
            ...
            },
            {
                ...
                description: 'Fonte de energia padrão ATX, focada em produtos que não utilizem consumo elevado. Produto de qualidade e custo benefício. A Fonte ATX Fortrek Crusader é uma fonte de alimentação com potência nominal de 500W.',
                categories_id: 2,
                stock: 19,
                brand: 'Fortrek',
            ...
            },
            {
                ...
                description: 'A bicicleta KRW X42 foi desenvolvida para quem quer realizar um passeio e pegar trilhas leves. Com seu quadro em alumínio 6061, fornece segurança e leveza no seu pedal. Possuí diversas cores que garante um estilo próprio para você.',
                categories_id: 1,
                stock: 8,
                brand: 'KRW',
                sales_format: 'Unidade',
